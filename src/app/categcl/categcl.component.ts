...
@Component({
  selector: 'app-categcl',
  templateUrl: './categcl.component.html',
  styleUrls: ['./categcl.component.css']
})
export class CategclComponent implements OnInit,OnDestroy {
  filtered: [any];
  all: [any];
  req:any;
  email:string;
